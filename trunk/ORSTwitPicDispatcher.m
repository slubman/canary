...
- (NSString *) uploadData:(NSData *)imageData
	...
	NSMutableURLRequest *postRequest = [NSMutableURLRequest requestWithURL:url
		cachePolicy:NSURLRequestUseProtocolCachePolicy timeoutInterval:21.0];
	...
	//NSLog(@"stringNode: %@", stringNode);
	NSXMLDocument *document = [[NSXMLDocument alloc] initWithXMLString:stringNode
		options:NSXMLDocumentTidyXML error:&documentError];
	NSXMLNode *root = [document rootElement];
	return [(NSXMLNode *)[[root nodesForXPath:@".//mediaurl" error:&nodeError] 
